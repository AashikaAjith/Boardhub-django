...
class InvalidPasswordResetTests(TestCase):
    ...
    def test_redirection(self):
        """Even invalid emails should redirect to `password_reset_done`"""
        url = reverse('password_reset_done')
        self.assertRedirects(self.response, url)
...
# ------------------------
# PASSWORD RESET CONFIRM VIEW (VALID TOKEN)
# ------------------------
class PasswordResetConfirmTests(TestCase):
    ...
    def test_form_inputs(self):
        """The view must contain three inputs: csrf + two password fields"""
        self.assertContains(self.response, '<input', 3)
        self.assertContains(self.response, 'type="password"', 2)


# ------------------------
# PASSWORD RESET CONFIRM VIEW (INVALID TOKEN)
# ------------------------
class InvalidPasswordResetConfirmTests(TestCase):
    ...
    def test_html(self):
        ...
        self.assertContains(self.response, 'invalid password reset link', html=False)
...
class PasswordResetCompleteTests(TestCase):
    ...
    def test_status_code(self):
        """The password reset complete page should return HTTP 200."""
        self.assertEqual(self.response.status_code, 200)

    def test_view_function(self):
        """The correct view class should be used."""
        view = resolve('/reset/complete/')
        self.assertEqual(view.func.view_class, auth_views.PasswordResetCompleteView)

    def test_contains_login_link(self):
        """The page should contain a link back to the login page."""
